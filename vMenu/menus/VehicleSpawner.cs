...
namespace vMenuClient
{
    public class VehicleSpawner
    {
        ...
        private void CreateMenu()
        {
            ...
            // Vehicle Addons List
            Menu addonCarsMenu = new Menu("~h~~r~Addon Vehicles", "~g~Spawn An Addon Vehicle");
            MenuItem addonCarsBtn = new MenuItem("~h~~r~Addon Vehicles", "~g~A list of addon vehicles available on this server.") { Label = "→→→" };
